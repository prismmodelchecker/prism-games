...
Team/coalition formation algorithms using learning \cite{abdallah2004organization}.

Team formation for task completion \cite{manisterski2006forming}.

Team formation in uncertain information setting \cite{kraus2003coalition}.

Task allocation via coalition formation \cite{shehory1998methods}.
...
Formal analysis of coalition games: Coalitional Game Logic \cite{agotnes2009reasoning}. Other formalisms like Cooperative Boolean Games were introduced \cite{dunne2008cooperative}.


Formal analysis techniques for gossiping protocols \cite{bakhshi2007formal}.

Analysis of clock synchronisation in wireless sensor networks \cite{heidarian2009analysis}.
