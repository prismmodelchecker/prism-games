...
these values are well defined \cite{Con93}
...
The intuition behind choosing these two types of rewards is that $W_2$ will provide 
incentives for agents to form smallest teams which can accomplish tasks, whereas $W_1$
motivates agent to be in a successful team. From organisation's point of view $W_1$ reward 
shall be used when the resources are limited, and $W_2$ will encourage agents to introduce
resource redundancy into the teams, but this may ensure that tasks are completed with higher 
probability.
...
\begin{figure}[H]
\subfloat[Offline. Reward $W_1(O)$.]{
\includegraphics[clip=true, trim=61 523 320 112, scale=0.77]{images/w1_stpg_offline}
}
\subfloat[Online. Reward $W_1(O)$.]{
...
\subfloat[Offline. Reward $W_2(O)$.]{
\includegraphics[clip=true, trim=120 520.5 270 115, scale=0.77]{images/w2_stpg_offline}
}
\subfloat[Online. Reward $W_2(O)$.]{
