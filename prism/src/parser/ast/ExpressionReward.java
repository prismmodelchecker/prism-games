...
public class ExpressionReward extends ExpressionQuant
{
	 ...
	 * @param constantValues Values of constants which may be needed to evaluate the index
	 */
	public int getRewardStructDivIndexByIndexObject(RewardGenerator rewardGen, Values constantValues) throws PrismException
	{
		return (rewardStructIndexDiv == null) ? -1 : getRewardStructIndexByIndexObject(rewardStructIndexDiv, rewardGen, constantValues);
	}
	 ...
	 * @param constantValues Values of constants which may be needed to evaluate the index
	 */
	public int getRewardStructDivIndexByIndexObject(List<String> rewardStructNames, Values constantValues) throws PrismException
	{
		return (rewardStructIndexDiv == null) ? -1 : getRewardStructIndexByIndexObject(rewardStructIndexDiv, rewardStructNames, constantValues);
	}
