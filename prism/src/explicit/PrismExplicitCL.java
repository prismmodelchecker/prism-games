...
/**
 * Command-line interface to the subset of PRISM's functionality
 * implemented purely using explicit-state data structure.
 */
public class PrismExplicitCL
{
	// flags
		...
		for (i = 0; i < undefinedConstants.getNumModelIterations(); i++) {
			...
			for (j = 0; j < numPropertiesToCheck; j++) {
				...
				if (simulate && undefinedConstants.getNumPropertyIterations() > 1) {
					throw new RuntimeException("No simulation");
				}
