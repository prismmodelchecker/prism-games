...
This case study [KPS13] models the system in PRISM-games as a
turn-based stochastic multi-player game (SMG/TSG). Another version of this
model, as a concurrent stochastic game (CSG), from [KNPS18] is also available,
the files for which can be found in ../../csgs/user-centric.
